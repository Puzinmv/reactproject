...
import { 
    ...
    COMPANIES, EMAILS, FIELD_NAMES
} from '../constants/index.js';
//import InputAdornment from '@mui/material/InputAdornment';
import {
    fetchCard, fetchUser, UpdateData, fetchProjectCardHistory
                                ...
                                <Stack direction="row" spacing={1.5} alignItems="center">
                                    ...
                                    <Box>
                                        ...
                                        <Typography variant="body2" color="text.secondary">
                                            Карта №{formData.id || rowid}
                                        </Typography>
                                    </Box>
                                </Stack>
                                <Tooltip title="Закрыть">
                                    <IconButton onClick={() => setHistoryPanelOpen(false)} aria-label="Закрыть историю изменений">
                                        <CloseIcon />
                                    </IconButton>
                                </Tooltip>
                            </Box>
